...
#' @param eta Input eta value
#' @param alpha Input alpha value
#' @param beta Input beta value
#' @keywords practice
#' @export
#' @examples
#' #four para model
...
pred_dist<-function(data,startyear,endyear,gamma,eta,alpha,beta){
  ...
  for(yy in 1:length(years) ){
    ...
    gamma_eta_alpha_beta = c(gamma,eta,alpha,beta)
