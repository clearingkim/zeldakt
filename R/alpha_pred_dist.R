#' Predicted Distance Function(Alpha-only)
#'
#' This function allows you to produce the predicted distance (alpha-only) of moving actors in your dataset
...
#' data(acled)
#' data<-acled
#' pred_alpha<-alpha_pred_dist(data,1999,2000)
